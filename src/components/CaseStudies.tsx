...
export default function CaseStudies({ showAll = false }: { showAll?: boolean }) {
  const allCaseStudies = [
    {
      title: "RookGPT – AI Chess Coach",
      description: "Designing an intelligent chess coaching experience powered by AI for players of all skill levels",
      category: "AI/ML Design",
      categoryType: "Product Design" as const,
      link: "/case-studies/rookgpt",
      gradient: "slate-gray" as const,
      iconType: "ai-coach" as const
    },
    {
      title: "Uplift – Community Health Worker Training Platform",
      description: "Mobile-first design system and platform for training community health workers in underserved regions",
    ...
    },
    {
      ...
      categoryType: "Design Leadership" as const,
  ...
  // Show only first 3 on homepage, all 8 on dedicated page
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-2">
                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                    study.categoryType === "Product Design" 
